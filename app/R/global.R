...
locations <- tibble::tribble(
  ...
  "Alta.",              50,      -112L,         49.5,         -119L,       1,     1,
  "Sask.",              50,      -106L,         50.5,         -120L,     0.5,     1,
  "Man.",               50,       -99L,           51,         -119L,       0,     1,
  "Ont.",               49,       -85L,         51.5,         -121L,       0,   0.5,
  "Que.",               53,       -70L,           54,         -122L,       0,   0.5,
  "N.L.",               53,       -62L,           55,         -122L,       0,     0,
  "N.S.",               45,       -63L,         52.5,         -120L,       0,     0,
  "N.B.",               46,       -67L,           52,         -122L,       0,     1,
  "P.E.I.",          46.25,       -63L,           53,         -122L,       0,    -1,
  "Nvt.",               65,      -100L,           57,         -122L,       0,     0,
  "N.W.T.",             65,      -125L,           58,         -122L,       0,     0,
  "Y.T.",               65,      -135L,           58,         -128L,       0,     0,
  "International",      55,      -138L,           55,         -129L,       1,     0
)
